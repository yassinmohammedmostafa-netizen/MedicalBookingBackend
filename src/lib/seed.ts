...
export async function seedIfEmpty() {
  ...
  const doctorData = [
    { firstName: "Ahmed", lastName: "Karim", specialty: "Anxiety & Stress", type: "psychiatrist", sessionType: "individual", gender: "male", price: 350, rating: 5, reviewCount: 48, bio: "Board-certified psychiatrist with 12 years experience specializing in anxiety disorders and stress management.", freeConsultation: false, yearsExperience: 12, languages: ["Arabic", "English"] },
    { firstName: "Sara", lastName: "Hassan", specialty: "Depression", type: "psychologist", sessionType: "individual", gender: "female", price: 280, rating: 5, reviewCount: 62, bio: "Clinical psychologist focused on CBT for depression and mood disorders. Creating a safe space for every patient.", freeConsultation: true, yearsExperience: 8, languages: ["Arabic"] },
    { firstName: "Omar", lastName: "Farid", specialty: "OCD", type: "psychiatrist", sessionType: "individual", gender: "male", price: 400, rating: 4, reviewCount: 31, bio: "Specialist in OCD and related disorders using ERP therapy with high success rates.", freeConsultation: false, yearsExperience: 15, languages: ["Arabic", "English", "French"] },
    { firstName: "Nadia", lastName: "Salah", specialty: "Child & Adolescent", type: "psychologist", sessionType: "group", gender: "female", price: 200, rating: 5, reviewCount: 89, bio: "Child psychologist dedicated to helping young people navigate emotional challenges and grow with confidence.", freeConsultation: true, yearsExperience: 10, languages: ["Arabic", "English"] },
    { firstName: "Khaled", lastName: "Mansour", specialty: "Addiction", type: "psychiatrist", sessionType: "both", gender: "male", price: 450, rating: 4, reviewCount: 25, bio: "Addiction medicine specialist helping patients reclaim their lives through evidence-based treatment programs.", freeConsultation: false, yearsExperience: 20, languages: ["Arabic"] },
    { firstName: "Mariam", lastName: "Youssef", specialty: "Trauma & PTSD", type: "psychologist", sessionType: "individual", gender: "female", price: 320, rating: 5, reviewCount: 54, bio: "Trauma-focused therapist using EMDR and somatic approaches to help survivors heal and thrive.", freeConsultation: false, yearsExperience: 7, languages: ["Arabic", "English"] },
  ];
